...
*NOTE: We used the verson mentioned above, but newer versions should still work in this setup. The location of certain items in Mission Planner may be moved, changed, or renamed. Please research the user documentation or online help in that case.*
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/MP-select-frame.png" />
</p>
<p>
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/MP-compass.png" />
</p>
<p>

See <a href="https://ardupilot.org/copter/docs/configuring-hardware.html">Mandatory Hardware Configuration</a> on the Ardupilot website for more information about hardware configuration.
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/mp-data.png" />
</p>
<p>

Once configured correctly, the rover can be controlled using either a romote controller or by uploading a mission plan using the PLAN tab on Mission Planner in the top left of the application window. Once in the appropriate tab, simply click on the map to define a waypoint, which can also be moved by clicking and dragging on it. The waypoint behavior can be specified as shown in the figure below. On the right of the application window, the plan can be saved to a file, and sent (using "Write") to the Pixhawk Microcontroller. Once a plan is sent to the Pixhawk, with the rover on, the mission can be started using the DATA tab on Mission Planner. 
  
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/mp-plan.png" />
</p>
<p>
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/MP-params.png" />
</p>
<p>
...
For each board, attach the radio antenna to the UHF port, and attach the GNSS antenna to the GNSS port (the GNSS antenna is the rectangular block with the metal disc and long cable; the straight rigid antenna is the radio antenna).
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/u-center_COMBAUD.png" />
</p>
<p>
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/u-center_openMessages.png" />
</p>
<p>
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/ubx-cfg-tmode3.png" />
</p>
<p>
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/ubx-cfg-msg.png" />
</p>
<p>
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/ubx-base-dataview.png" />
</p>
<p>
  
#### Setting up the rover module

After connecting the u-center application to the rover module, only the UBX-CFG-PRT message needs to be sent. Ensure that only RTCM messages from the base station are being received using UART1, and specify the same baud rate used by the base station. Click Send.
...
<p align="center">
  <img src="https://github.com/Mercer-Robotics-Club/High_Accuracy_GPS/blob/main/Software/Images/ubx-rover-dataview.png" />
</p>
<p>
